...
/stackable.sh testdriver-1 -i /.cluster/key "git clone -b $GIT_BRANCH https://github.com/stackabletech/spark-operator-integration-tests.git"
/stackable.sh testdriver-1 -i /.cluster/key 'cd spark-operator-integration-tests/ && cargo test -- --test-threads=1'
