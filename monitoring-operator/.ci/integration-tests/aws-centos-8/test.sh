...
/stackable.sh testdriver-1 -i /.cluster/key "git clone -b $GIT_BRANCH https://github.com/stackabletech/monitoring-operator-integration-tests.git"
/stackable.sh testdriver-1 -i /.cluster/key 'cd monitoring-operator-integration-tests/ && cargo test -- --test-threads=1'
exit_code=$?
