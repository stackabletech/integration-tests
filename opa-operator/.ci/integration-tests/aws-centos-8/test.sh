...
/stackable.sh testdriver-1 -i /.cluster/key "git clone -b $GIT_BRANCH https://github.com/stackabletech/opa-operator-integration-tests.git"
/stackable.sh testdriver-1 -i /.cluster/key 'cd opa-operator-integration-tests/ && cargo test -- --test-threads=1'
exit_code=$?
